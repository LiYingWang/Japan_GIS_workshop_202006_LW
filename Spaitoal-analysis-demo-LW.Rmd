...
set up set location, demostrate and explain each line (5 mins)
...
download raster data for Japan: https://www.gsi.go.jp/kankyochiri/gm_japan_e.html
...
talk about sahpefile, read and add the shapefile (site location) onto raster data (5 mins)
...
K1 <- density(sp_sites_location) # Using the default bandwidth
