...
```{r read-shapefile}
# download the zip file into our data folder
download.file("https://github.com/LiYingWang/Japan_GIS_workshop_202006_LW/raw/master/data/shapefile.zip", "data/site_shapefile.zip")
# unzip to the data folder
unzip(zipfile = "data/site_shapefile.zip", exdir = "data")
# delete zip file
unlink("data/site_shapefile.zip")

sites_location <- st_read(here::here("shapefile", "sites_example.shp"))
