...
# Exercise: load data and check it (2 mins)
...
# Exercise: create country labels for the regional map (2 mins)
...
# Exercise: convert raster data to a dataframe for plotting (5 mins)
...
# Exercise: extract elevation and make a plot to compare sites from two phases (5 mins)
...
sites_location_ppp_kofun <- (ppp(x = sites_location_coords_kofun$X,
                                 ...
                                 range(crop_DEM_df$x$X),
                                 range(crop_DEM_df$x$Y))) 
